...
//					agenteApcBD.getChild("estado").setText("aberta");
		...
		/**
		 * Nesse comportamento TickerBehaviour é analisado primeiramente o valor de CR. Esse comportamento
...
*/					}// fim do if(deltaP<0) 
					...
					System.out.println("A microrrede está conectada!");
					
					
					
					
				}else{
					System.out.println("Problema! Não entrou no modo conectado e nem no desconectado!!");
				}// fim do if para saber se entrou no modo conectado ou no modo desconectado
				
				
			}// fim do segundo onTick 
		}); // Fim do segundo TickerBehaviour 	
